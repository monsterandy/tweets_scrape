...
#SBATCH --job-name="21-04_immigration_prep"
#SBATCH --output=ccr_outputs/preprocess/general/prep_immigration_2021-04.out
...
echo "Job start!"
python preprocess.py -n immigration_2021-04
