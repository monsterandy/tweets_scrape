...
#SBATCH --job-name="20-12_immigration_prep"
#SBATCH --output=ccr_outputs/preprocess/general/prep_immigration_2020-12.out
...
echo "Job start!"
python preprocess.py -n immigration_2020-12
