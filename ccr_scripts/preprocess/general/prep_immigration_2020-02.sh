...
#SBATCH --job-name="20-02_immigration_prep"
#SBATCH --output=ccr_outputs/preprocess/general/prep_immigration_2020-02.out
...
echo "Job start!"
python preprocess.py -n immigration_2020-02
