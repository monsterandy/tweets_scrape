...
#SBATCH --job-name="21-02_immigration_prep"
#SBATCH --output=ccr_outputs/preprocess/general/prep_immigration_2021-02.out
...
echo "Job start!"
python preprocess.py -n immigration_2021-02
