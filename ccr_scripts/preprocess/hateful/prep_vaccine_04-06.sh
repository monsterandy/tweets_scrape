...
#SBATCH --job-name="04_vaccine_prep"
#SBATCH --output=ccr_outputs/prep_vaccine_04.out
...
echo "Job start!"
python preprocess.py -n vaccine_04
python preprocess.py -n vaccine_05
python preprocess.py -n vaccine_06
