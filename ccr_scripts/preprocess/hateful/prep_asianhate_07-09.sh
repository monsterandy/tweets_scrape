...
#SBATCH --job-name="08_asianhate_prep"
#SBATCH --output=ccr_outputs/prep_asianhate_08.out
...
echo "Job start!"
python preprocess.py -n asianhate_07
python preprocess.py -n asianhate_08
python preprocess.py -n asianhate_09
