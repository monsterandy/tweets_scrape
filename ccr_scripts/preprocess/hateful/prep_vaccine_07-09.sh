...
#SBATCH --job-name="08_vaccine_prep"
#SBATCH --output=ccr_outputs/prep_vaccine_08.out
...
echo "Job start!"
python preprocess.py -n vaccine_07
python preprocess.py -n vaccine_08
python preprocess.py -n vaccine_09
