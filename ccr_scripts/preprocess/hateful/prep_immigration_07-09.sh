...
#SBATCH --job-name="08_immigration_prep"
#SBATCH --output=ccr_outputs/prep_immigration_08.out
...
echo "Job start!"
python preprocess.py -n immigration_07
python preprocess.py -n immigration_08
python preprocess.py -n immigration_09
