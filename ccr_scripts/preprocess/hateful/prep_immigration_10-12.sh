...
#SBATCH --job-name="12_immigration_prep"
#SBATCH --output=ccr_outputs/prep_immigration_12.out
...
echo "Job start!"
python preprocess.py -n immigration_10
python preprocess.py -n immigration_11
python preprocess.py -n immigration_12
