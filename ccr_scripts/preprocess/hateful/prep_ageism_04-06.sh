...
#SBATCH --job-name="04_ageism_prep"
#SBATCH --output=ccr_outputs/prep_ageism_04.out
...
echo "Job start!"
python preprocess.py -n ageism_04
python preprocess.py -n ageism_05
python preprocess.py -n ageism_06
