...
#SBATCH --job-name="12_vaccine_prep"
#SBATCH --output=ccr_outputs/prep_vaccine_12.out
...
echo "Job start!"
python preprocess.py -n vaccine_10
python preprocess.py -n vaccine_11
python preprocess.py -n vaccine_12
