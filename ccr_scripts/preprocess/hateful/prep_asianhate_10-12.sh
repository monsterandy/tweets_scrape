...
#SBATCH --job-name="12_asianhate_prep"
#SBATCH --output=ccr_outputs/prep_asianhate_12.out
...
echo "Job start!"
python preprocess.py -n asianhate_10
python preprocess.py -n asianhate_11
python preprocess.py -n asianhate_12
