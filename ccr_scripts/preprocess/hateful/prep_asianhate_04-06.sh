...
#SBATCH --job-name="04_asianhate_prep"
#SBATCH --output=ccr_outputs/prep_asianhate_04.out
...
echo "Job start!"
python preprocess.py -n asianhate_04
python preprocess.py -n asianhate_05
python preprocess.py -n asianhate_06
