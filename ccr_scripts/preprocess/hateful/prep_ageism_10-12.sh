...
#SBATCH --job-name="12_ageism_prep"
#SBATCH --output=ccr_outputs/prep_ageism_12.out
...
echo "Job start!"
python preprocess.py -n ageism_10
python preprocess.py -n ageism_11
python preprocess.py -n ageism_12
