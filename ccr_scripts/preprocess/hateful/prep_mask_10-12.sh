...
#SBATCH --job-name="12_mask_prep"
#SBATCH --output=ccr_outputs/prep_mask_12.out
...
echo "Job start!"
python preprocess.py -n mask_10
python preprocess.py -n mask_11
python preprocess.py -n mask_12
