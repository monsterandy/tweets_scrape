...
#SBATCH --job-name="08_ageism_prep"
#SBATCH --output=ccr_outputs/prep_ageism_08.out
...
echo "Job start!"
python preprocess.py -n ageism_07
python preprocess.py -n ageism_08
python preprocess.py -n ageism_09
