...
#SBATCH --job-name="04_immigration_prep"
#SBATCH --output=ccr_outputs/prep_immigration_04.out
...
echo "Job start!"
python preprocess.py -n immigration_04
python preprocess.py -n immigration_05
python preprocess.py -n immigration_06
