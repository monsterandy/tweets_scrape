...
#SBATCH --job-name="21-02_mask"
#SBATCH --output=ccr_outputs/scrape/general/job_mask_2021-02.out
...
echo "Job start!"
python autocommand.py -t mask -s 2021-02-01 -e 2021-02-28
python scrape_tweets.py -n mask_2021-02
python image_extract.py -n mask_2021-02
