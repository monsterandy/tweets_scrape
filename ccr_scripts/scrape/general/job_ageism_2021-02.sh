...
#SBATCH --job-name="21-02_ageism"
#SBATCH --output=ccr_outputs/scrape/general/job_ageism_2021-02.out
...
echo "Job start!"
python autocommand.py -t ageism -s 2021-02-01 -e 2021-02-28
python scrape_tweets.py -n ageism_2021-02
python image_extract.py -n ageism_2021-02
