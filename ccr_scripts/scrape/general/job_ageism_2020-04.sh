...
#SBATCH --job-name="20-04_ageism"
#SBATCH --output=ccr_outputs/scrape/general/job_ageism_2020-04.out
...
python scrape_tweets.py -n ageism_2020-04
python image_extract.py -n ageism_2020-04
