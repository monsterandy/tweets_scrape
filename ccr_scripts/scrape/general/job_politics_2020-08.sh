...
#SBATCH --job-name="20-08_politics"
#SBATCH --output=ccr_outputs/scrape/general/job_politics_2020-08.out
...
python scrape_tweets.py -n politics_2020-08
python image_extract.py -n politics_2020-08
