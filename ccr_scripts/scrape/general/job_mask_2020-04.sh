...
#SBATCH --job-name="20-04_mask"
#SBATCH --output=ccr_outputs/scrape/general/job_mask_2020-04.out
...
echo "Job start!"
python autocommand.py -t mask -s 2020-04-01 -e 2020-04-30
python scrape_tweets.py -n mask_2020-04
python image_extract.py -n mask_2020-04
