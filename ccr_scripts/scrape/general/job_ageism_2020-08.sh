...
#SBATCH --job-name="20-08_ageism"
#SBATCH --output=ccr_outputs/scrape/general/job_ageism_2020-08.out
...
echo "Job start!"
python autocommand.py -t ageism -s 2020-08-01 -e 2020-08-31
python scrape_tweets.py -n ageism_2020-08
python image_extract.py -n ageism_2020-08
