...
#SBATCH --job-name="20-12_mask"
#SBATCH --output=ccr_outputs/scrape/general/job_mask_2020-12.out
...
echo "Job start!"
python autocommand.py -t mask -s 2020-12-01 -e 2020-12-31
python scrape_tweets.py -n mask_2020-12
python image_extract.py -n mask_2020-12
