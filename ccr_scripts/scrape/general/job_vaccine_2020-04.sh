...
#SBATCH --job-name="20-04_vaccine"
#SBATCH --output=ccr_outputs/scrape/general/job_vaccine_2020-04.out
...
python scrape_tweets.py -n vaccine_2020-04
python image_extract.py -n vaccine_2020-04
