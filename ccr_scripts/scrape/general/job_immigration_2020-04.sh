...
#SBATCH --job-name="20-04_immigration"
#SBATCH --output=ccr_outputs/scrape/general/job_immigration_2020-04.out
...
python scrape_tweets.py -n immigration_2020-04
python image_extract.py -n immigration_2020-04
