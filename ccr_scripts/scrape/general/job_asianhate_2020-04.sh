...
#SBATCH --job-name="20-04_asianhate"
#SBATCH --output=ccr_outputs/scrape/general/job_asianhate_2020-04.out
...
python scrape_tweets.py -n asianhate_2020-04
python image_extract.py -n asianhate_2020-04
