...
#SBATCH --job-name="20-08_mask"
#SBATCH --output=ccr_outputs/scrape/general/job_mask_2020-08.out
...
echo "Job start!"
python autocommand.py -t mask -s 2020-08-01 -e 2020-08-31
python scrape_tweets.py -n mask_2020-08
python image_extract.py -n mask_2020-08
