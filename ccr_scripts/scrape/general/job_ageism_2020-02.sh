...
#SBATCH --job-name="20-02_ageism"
#SBATCH --output=ccr_outputs/scrape/general/job_ageism_2020-02.out
...
echo "Job start!"
python autocommand.py -t ageism -s 2020-02-01 -e 2020-02-29
python scrape_tweets.py -n ageism_2020-02
python image_extract.py -n ageism_2020-02
