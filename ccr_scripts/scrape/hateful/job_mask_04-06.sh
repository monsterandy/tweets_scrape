...
python scrape_tweets.py -n mask_04
python image_extract.py -n mask_04

python autocommand.py -t mask -s 2021-05-01 -e 2021-04-31
python scrape_tweets.py -n mask_05
python image_extract.py -n mask_05

python autocommand.py -t mask -s 2021-06-01 -e 2021-06-30
python scrape_tweets.py -n mask_06
python image_extract.py -n mask_06
