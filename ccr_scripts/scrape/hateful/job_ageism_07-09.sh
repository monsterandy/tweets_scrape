...
python image_extract.py -n ageism_07

python autocommand.py -t ageism -s 2021-08-01 -e 2021-08-31
python scrape_tweets.py -n ageism_08
python image_extract.py -n ageism_08

python autocommand.py -t ageism -s 2021-09-01 -e 2021-09-30
python scrape_tweets.py -n ageism_09
python image_extract.py -n ageism_09
